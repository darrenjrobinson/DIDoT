    ...
    public class IssuerController : ControllerBase
    {
        ...
        public async Task<ActionResult> IssuanceRequest()
        {
            try
            {
                ...
                payload["issuance"]["claims"]["product_name"] = "Identirati Elbow Pasta";
                payload["issuance"]["claims"]["allergen_name"] = "Nuts - This product may contain traces of nuts as it is produced on premises which produce nut products.";
                payload["issuance"]["claims"]["ingredient_name"] = "White Corn Flour, Yellow Corn Flour, Rice Flour, Red Lentil Flour, Water, Emulsifier: E471";
